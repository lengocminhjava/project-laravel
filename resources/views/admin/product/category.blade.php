                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="analytic">
                            ...
                            <a href="{{ url('admin/product/cat/request') }}" class="text-primary">Thùng rác
                        ...
                        <table class="table table-striped table-responsive">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col" class="width">Tác vụ</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if ($count[0] > 0)
                                    ...
                                    @foreach ($list_new as $item)
                                        ...
                                        <tr id="tr-data-{{ $item->id }}">
                                            ...
                                            <td>{{ $item->slug_url }}</td>
                                            <td><span class="status mr-3">{{ $item->status->name }}</span></td>
                                            <td>
                                                <a href="{{ route('update_cat', $item->id) }}"
                                                    class="btn btn-success btn-sm rounded-0 text-white mt-1" type="button"
                                                    data-toggle="tooltip" data-placement="top" title="Edit"><i
                                                        class="fa fa-edit"></i></a>
                                                <button
                                                    class="btn btn-danger btn-sm rounded-0 text-white delete_cat_products mt-1"
