            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="font-weight-bold" style="padding-left:1.25rem">
                        <a class="text-primary" href="{{ url('admin/product/cat/list') }}">Quay Lại</a>
                    </div>
                    <div class="card-body">
                                ...
                                @if ($category->total() > 0)
                                    ...
                                    @foreach ($category as $item)
                                        ...
                                        <tr class="tr-data-{{ $item->id }}">
                                            ...
                                            <td>
                                                <button
                                                    class="btn btn-success btn-sm rounded-0 text-white cat_restore_product"
                                                    data-id="{{ $item->id }}" type="button" data-toggle="tooltip"
                                                    data-placement="top" title="Restore"><i
                                                        class="fa fa-window-restore"></i></button>
                                                <button
                                                    class="btn btn-danger btn-sm rounded-0 text-white delete_cat_trash_product"
                                                    data-id="{{ $item->id }}" type="button" data-toggle="tooltip"
