            ...
            <div class="card-body">
                <form action="{{ route('role.action') }}"method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" placeholder="Tên vai trò" value="{{ old('name') }}"
                            name="name" id="name">
                        @error('name')
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="content" placeholder="Mô tả" id="content" rows="1"></textarea>
                        @error('content')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
